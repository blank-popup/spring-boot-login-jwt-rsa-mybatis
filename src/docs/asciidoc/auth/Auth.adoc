...
==== Request Headers
include::{snippets}/auth/ApiKey/request-headers.adoc[]
// ==== Path Parameters
// include::{snippets}/auth/ApiKey/path-parameters.adoc[]
==== Request Fields
include::{snippets}/auth/ApiKey/request-fields.adoc[]
// ==== Request Parameters
// include::{snippets}/auth/ApiKey/request-parameters.adoc[]
// ==== Request Parts
// include::{snippets}/auth/ApiKey/request-parts.adoc[]
==== Response Fields
include::{snippets}/auth/ApiKey/response-fields.adoc[]
==== Example of Request
include::{snippets}/auth/ApiKey/http-request.adoc[]
==== Example of Response
include::{snippets}/auth/ApiKey/http-response.adoc[]
