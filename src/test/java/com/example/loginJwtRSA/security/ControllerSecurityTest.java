...
//                        requestParts(),
                        responseFields(
                                CommonTest.createResponseFields(
                                        ...
                                        "The unique number of user signed up",
                                        false,
                                        null,
                                        1
                                ),
...
//                        requestParts(),
                        responseFields(
                                CommonTest.createResponseFields(
                                        "id",
                                        JsonFieldType.NUMBER,
                                        "The unique number of user signed in",
                                        false,
                                        null,
                                        1
                                ),
                                ...
                                CommonTest.createResponseFields(
                                        "token",
                                        JsonFieldType.STRING,
                                        "Json Web Token to use until being expired",
                                        false,
                                        "Bearer (Base64 Code).(Base64 Code).(Base64 Code)",
                                        "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIiwiaWF0IjoxNjc4NjIyODMzLCJleHAiOjE2Nzg3MDkyMzN9.CmiZeCJn1cZBehZ8SRcFNgovhvwgLuXjeS61i2RFdYc"
                                ),
                                CommonTest.createResponseFields(
                                        "roles",
                                        JsonFieldType.ARRAY,
